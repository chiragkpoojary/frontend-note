...
export function ProfileMenu() {
    ...
    const signin = (localStorage.getItem('jwtToken') ? true : false);
    let check;
    if (signin) {
        check = "Sign Out"
    } else {
    ...
    <Menu>
      <MenuHandler>
        {signin ?
            <div
                className="w-20 h-20 rounded-full bg-gray-900 flex items-center justify-center text-white text-3xl font-semibold">
            ...
            <Avatar
                ...
                src="data:image/jpeg;base64,"
            />
        }
      </MenuHandler>
      <MenuList>
        <MenuItem className="flex items-center gap-2">
          ...
          <Typography variant="small" className="font-medium">
                 <h3 className="w-fit text-sm rounded ml-5">
  {username}
</h3> 
          </Typography>
        </MenuItem>
        ...
        <MenuItem className="flex items-center gap-2 ">
          ...
          <Typography variant="small" className="font-medium">
            <button onClick={signout}>{check}</button>
